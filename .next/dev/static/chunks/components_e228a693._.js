...
function Navbar() {
    ...
    const linkStyle = (path)=>({
            ...
            color: pathname === path ? '#fff' : 'var(--subtle-text-color)',
            transition: 'color 0.3s ease',
            borderBottom: pathname === path ? '2px solid var(--accent-color-1)' : 'none',
            paddingBottom: '5px'
        });
...
//# sourceMappingURL=components_e228a693._.js.map